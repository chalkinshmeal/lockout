...
public class ReadyUpCommand extends ArgCommand {
    private final JavaPlugin plugin;
    private final ConfigHandler config;
    private final GameHandler gameHandler;

    // Constructor
    public ReadyUpCommand(JavaPlugin plugin, GameHandler gameHandler) {
        super("ready", false);
        setPlayerRequired(true);
        this.setHelpMsg(ChatColor.GOLD + this.getName() + ": " +
                        ChatColor.WHITE + "Indicates that you are ready for the game to start");
        this.plugin = plugin;
    ...
    protected void executeArgs(CommandSender sender, List<ArgValue> argValues, Set<String> usedFlags) {
        ...
        this.gameHandler.readyUp(player);
    }
}
