...
public class PlayerLeashEntityListener implements Listener {
    ...
    /** Constructor */
    public PlayerLeashEntityListener(JavaPlugin plugin, LabyrinthEventHandler labyrinthEventHandler) {
        this.plugin = plugin;
    ...
    public void onPlayerLeashEntity(PlayerLeashEntityEvent event) {
        this.labyrinthEventHandler.onPlayerLeashEntityEvent(event);
    }
}
