...
public class EnderdragonHealth extends LabyrinthItem {
    private final int health = 26; // 1/4 chance to evade
    public EnderdragonHealth(JavaPlugin plugin, ConfigHandler config, String className, String position, Game game) { super(plugin, config, className, position, game); }
