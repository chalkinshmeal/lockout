...
public class JumpVI extends LabyrinthItem {
    public JumpVI(JavaPlugin plugin, ConfigHandler config, String className, String position, Game game) { super(plugin, config, className, position, game); }
