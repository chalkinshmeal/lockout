...
public class BatFragile extends LabyrinthItem {
    private final int health = 14;
    public BatFragile(JavaPlugin plugin, ConfigHandler config, String className, String position, Game game) { super(plugin, config, className, position, game); }
