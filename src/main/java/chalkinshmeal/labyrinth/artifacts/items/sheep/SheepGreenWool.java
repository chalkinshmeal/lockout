...
public class SheepGreenWool extends LabyrinthItem {
    public SheepGreenWool(JavaPlugin plugin, ConfigHandler config, String className, String position, Game game) { super(plugin, config, className, position, game); }
