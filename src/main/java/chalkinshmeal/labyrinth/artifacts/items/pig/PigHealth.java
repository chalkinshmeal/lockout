...
public class PigHealth extends LabyrinthItem {
    private final int health = 24;
    public PigHealth(JavaPlugin plugin, ConfigHandler config, String className, String position, Game game) { super(plugin, config, className, position, game); }
