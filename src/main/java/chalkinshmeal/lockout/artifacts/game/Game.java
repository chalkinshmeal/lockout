...
import chalkinshmeal.lockout.artifacts.cooldown.CooldownHandler;
import chalkinshmeal.lockout.artifacts.scoreboard.LabyrinthScoreboard;
import chalkinshmeal.lockout.listeners.game.*;

import java.util.*;

import static chalkinshmeal.lockout.utils.Utils.*;
...
public class Game {
    ...
    public Game(JavaPlugin plugin) {
        ...
        this.scoreboard = new LabyrinthScoreboard(plugin, null);
